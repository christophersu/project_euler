...
for row in range(16): # go down the rows of the list
	for column in range(16):
		if (grid[row][column]*grid[row+1][column+1]*grid[row+2][column+2]*grid[row+3][column+3]) > greatestProduct:
			greatestProduct = grid[row][column]*grid[row+1][column+1]*grid[row+2][column+2]*grid[row+3][column+3]

# check / diagonals
for row in range(3,19): # go down the rows of the list
	for column in range(16):
		if (grid[row][column]*grid[row-1][column+1]*grid[row-2][column+2]*grid[row-3][column+3]) > greatestProduct:
			greatestProduct = grid[row][column]*grid[row-1][column+1]*grid[row-2][column+2]*grid[row-3][column+3]
